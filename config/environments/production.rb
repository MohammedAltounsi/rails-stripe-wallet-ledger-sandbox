...
Rails.application.configure do
  ...
  # Outgoing SMTP — provider-agnostic, configured entirely from ENV so no secret
  # is committed. Set SMTP_ADDRESS et al. in the host dashboard (see DEPLOY.md).
  # With SMTP_ADDRESS unset, mail is simply not delivered (the app still runs).
